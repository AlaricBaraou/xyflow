...
function EdgeWrapper<EdgeType extends Edge = Edge>({
  ...
  // subscribe to this edge through the per-edge channel: re-renders only when its own object changes
  // (setEdges wakes it) or an endpoint node moves (incidentEdges), not on every store emit
  ...
  const { zIndex, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition } =
    sourceNode && targetNode
      ...
      : { zIndex: edge.zIndex, ...nullPosition };
